...
#define PREMIUM_MEAN_SERVICE_TIME 120 //120 sec; this value is used also as mean service time for reliable analysis multi server queue node
#define NORMAL_MEAN_SERVICE_TIME 150 //150 sec
#define RELIABLE_MEAN_SERVICE_TIME 75 //75 no imp; 300 imp
#define DIGEST_MEAN_SERVICE_TIME 0.6 // 0.6 sec
#define MEAN_INTERARRIVAL_TIME 0.8640 //0.8640 in normal situation; 0.617142857
...
#define N_RELIABLE 1 // number of servers in realiable analysis multi server queue node; 1 no imp; 45 imp
