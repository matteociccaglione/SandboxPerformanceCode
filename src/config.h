...
#define RELIABLE_MEAN_SERVICE_TIME 300           // E(Si) for Reliable Analysis Center; 75 sec original system; 300 sec improved system
#define DIGEST_MEAN_SERVICE_TIME 0.6            // E(S) for Digest Center
#define MEAN_INTERARRIVAL_TIME 0.617142857          // 0.8640 in original system (100K jobs per day); set to 0.617142857 for 140K jobs per day
...
#define N_RELIABLE 45                            // number of servers of the Reliable Analysis center; 1 (SSQ) in the original system; 45 in the improved system (optimal value)
#define TIMEOUT 300                             // timeot of Normal and Premium Analysis centers; optimal values: 600 sec in the original system, 300 sec in the improved system
#define TIMEOUT_RELIABLE 1080                    // timeout of Reliable Analysis center; optimal values: 900 sec in the original system, 1080 sec in the improved system
...
#define IMPROVEMENT 1                           // set this value to 1 to run the simulation of the improved system; 0 to run it for the original system
#endif
